...
function AdminEnrollments() {
  const { data, deleteEnrollment, setEnrollmentStatus, syncEnrollments, syncStudents, syncProgress } = useLms();
  ...
  useEffect(() => {
    if (detailsId || editId) void syncProgress();
  }, [detailsId, editId, syncProgress]);
